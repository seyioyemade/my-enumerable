...
**My Enumerable** is a project that implements a subset of the functionality
...
```sh
   git clone https://github.com/seyioyemade/my-enumerable.git
```
...
- [ ] **Add_more_enumerable_methods**<br/>
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- CONTRIBUTING -->
...
Feel free to check the [issues page](https://github.com/seyioyemade/my-enumerable/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- SUPPORT -->
